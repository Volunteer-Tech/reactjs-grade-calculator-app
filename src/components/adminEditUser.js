...
class AdminEditUser extends React.Component {
    constructor(props) {
        ...
        this.state = {
            ...
            archived: this.props.location.archived,
    ...
    handleSubmit(e) {
        ...
        axios.put('http://localhost:3000/api/v1/users/' + this.state.userid, data)
                    ...
                    <div className="row justify-content-sm-center">
                        <div className="col-sm-6 editform">
                            <form className="form-signin" onSubmit={(e) => this.handleSubmit(e)}>
                                ...
                                <select name="archived" value={this.state.archived}  onChange={this.handleInputChange}>
