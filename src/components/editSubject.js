...
class EditSubject extends React.Component {
    ...
    handleSubmit(e) {
        ...
        axios.put('http://localhost:3000/api/v1/subjects/'+ this.state.subjectId, data)
                    ...
                    <div className="row justify-content-sm-center">
                        <div className="col-sm-6 editform">
                            <form className="form-signin" onSubmit={(e) => this.handleSubmit(e)}>
                                ...
                                <input type="text" value={this.state.subjectName} name="subjectName" value={this.state.subjectName}
                                ...
                                <select name="classId" value={this.state.classId} required onChange={this.handleInputChange}>
                                    <option>Please select</option>
                                    {classList}
                                </select>
                                <br/>
                                <label >Teacher Name</label>
                                <select name="teacherId" value={this.state.teacherId} required onChange={this.handleInputChange}>
                                    <option >Please select</option>
                                    {userList}
                                </select>
